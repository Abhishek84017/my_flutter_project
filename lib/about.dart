              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                        text:
                            'Around we develop Youth that is more efficient, More Valuable to Nation.\n'),
                    WidgetSpan(
                        child: SizedBox(
                      height: 30.h,
                    )),
                    TextSpan(
                        text:
                            'We are here to Channelize Energy of Youth in Direction that is helpful to all. WE BELEIVE IN.\n'),
                    WidgetSpan(
                        child: SizedBox(
                      height: 50.h,
                    )),
                    TextSpan(
                        text: '#ServeSoceity #ServeNation',
